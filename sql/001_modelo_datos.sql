...
select
  ...
  case when cal.dias_trabajados > 0
       then round(coalesce(ve.fact_nc,0) / cal.dias_trabajados * cal.dias_totales, 2)
  ...
  case when o.obj_venta > 0 and cal.dias_trabajados > 0
       then round((coalesce(ve.fact_nc,0) / cal.dias_trabajados * cal.dias_totales) / o.obj_venta, 4)
